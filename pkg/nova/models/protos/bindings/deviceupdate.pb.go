...
const file_deviceupdate_proto_rawDesc = "" +
	"\n" +
	"\x12deviceupdate.proto\x1a\fcommon.proto\"\x85\x01\n" +
	...
	"\x13DEVICE_TYPE_EARBUDS\x10\x1aBCZAgithub.com/dylanmazurek/go-findmy/pkg/nova/models/protos/bindingsb\x06proto3"

var (
	file_deviceupdate_proto_rawDescOnce sync.Once
	file_deviceupdate_proto_rawDescData []byte
)

func file_deviceupdate_proto_rawDescGZIP() []byte {
	file_deviceupdate_proto_rawDescOnce.Do(func() {
		file_deviceupdate_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_deviceupdate_proto_rawDesc), len(file_deviceupdate_proto_rawDesc)))
	})
...
func file_deviceupdate_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_deviceupdate_proto_rawDesc), len(file_deviceupdate_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   42,
			NumExtensions: 0,
			NumServices:   0,
